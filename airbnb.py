...
def streamlit_config():
    ...
    # page configuration
    page_icon_url = 'https://github.com/TamizHari/Airbnb_analysis/blob/main/airbnb_logo.jpg'
...
class data_collection:
    client = pymongo.MongoClient("mongodb+srv://tamizhari2205:RjcjimlX9oFU0SkY@tamizhari.fmo5hqs.mongodb.net/?retryWrites=true&w=majority&appName=Tamizhari")
    db = client['sample_airbnb']
    col = db['listingsAndReviews']

class data_preprocessing:
    def primary(): #==============================Primary_function===============>>>>>>>>>>>>>>>>>>>>
        # direct feature columns
        data = []
        for i in data_preprocessing({}, {'_id': 1, 'listing_url': 1, 'name': 1, 'property_type': 1, 'room_type': 1, 'bed_type': 1,
...
class sql:
    ...
    def create_table():
        ...
        mycursor.execute("create database if not exists air_bnb")

        mycursor.execute(f"""create table if not exists air_bnb.airbnb(
    ...
    def data_migration():
        ...
        mycursor.executemany("insert into air_bnb.airbnb \
    ...
    def delete_table():
        ...
        for i in mycursor:
            print(i)
        mycursor.execute(f"""delete from air_bnb.airbnb;""")
        mydb.commit()
        mydb.close()
...
with st.sidebar:
    image_url = 'https://github.com/TamizHari/Airbnb_analysis/blob/main/airbnb_banner.jpg'
